...
import VmForm3 from "@/../lib/vmform/designer.umd.js"; // 引入VmForm3库(移动端)
import "@/../lib/vmform/designer.style.css"; //引入VmForm3样式
...
import vuePlugin from "@/plugins/package/highlight"; // 引入代码高亮插件
...
app.component('TextEllipsisTooltip', TextEllipsisTooltip)
...
app.use(VmForm3); //全局注册VmForm3，同时注册了vm-form-designer、vm-form-render等组件
app.use(Vant); //全局注册vant
app.use(hljsVuePlugin);
app.use(vuePlugin);
app.use(VueVirtualScroller); // 注册虚拟滚动组件
