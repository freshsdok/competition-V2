<template>
  <div class="panel-tab__content">
    <el-form size="default" label-width="90px" @submit.native.prevent>
...
<!--      <el-button size="default" type="primary" icon="el-icon-plus" @click="openFieldForm(null, -1)">添加字段</el-button>-->
<!--    </div>-->

    <!--字段配置侧边栏-->
<!--    <el-drawer v-model="fieldModelVisible" title="字段配置" :size="`${width}px`" append-to-body destroy-on-close>-->
<!--      <el-form :model="formFieldForm" label-width="90px" size="default" @submit.native.prevent>-->
...
<!--        </p>-->
<!--        <el-table :data="fieldEnumList" size="default" key="enum-table" max-height="240" border fit>-->
...
<!--      </p>-->
<!--      <el-table :data="fieldConstraintsList" size="default" key="validation-table" max-height="240" border fit>-->
<!--        <el-table-column label="序号" width="50px" type="index" />-->
...
<!--      </p>-->
<!--      <el-table :data="fieldPropertiesList" size="default" key="property-table" max-height="240" border fit>-->
<!--        <el-table-column label="序号" width="50px" type="index" />-->
...
<!--    </el-drawer>-->
    ...
    <el-dialog v-model="fieldOptionModelVisible" :title="optionModelTitle" width="600px" append-to-body destroy-on-close>
      <el-form :model="fieldOptionForm" size="default" label-width="96px" @submit.native.prevent>
