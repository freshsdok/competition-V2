<template>
  <div class="panel-tab__content">
    <div class="panel-tab__content--title">
      ...
      <el-button size="default" type="primary" icon="el-icon-plus" @click="openModel('message')">创建新消息</el-button>
    </div>
    ...
    <div class="panel-tab__content--title" style="padding-top: 8px; margin-top: 8px; border-top: 1px solid #eeeeee">
      ...
      <el-button size="default" type="primary" icon="el-icon-plus" @click="openModel('signal')">创建新信号</el-button>
    </div>
    ...
    <el-dialog v-model="modelVisible" :title="modelConfig.title" :close-on-click-modal="false" width="400px" append-to-body destroy-on-close>
      <el-form :model="modelObjectForm" size="default" label-width="90px" @submit.native.prevent>
      ...
      <template #footer>
        <el-button size="default" @click="modelVisible = false">取 消</el-button>
        <el-button size="default" type="primary" @click="addNewObject">保 存</el-button>
      </template>
    </el-dialog>
  </div>
</template>
