...
<el-dialog :title="title"
  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" 
      ...
      <el-table-column label="学校" align="left" prop="schoolName" min-width="100px"  show-overflow-tooltip/>
  ...
  <template #footer>
    <div class="dialog-footer">
      <el-button type="primary" @click="submitForm">添加选中</el-button>
...
// 导入API
import { systemUserGroupList } from "@/api/fileTask";
// 导入工具
 ...
 * @param {string} info.formKey - 表单字段标识
 */
let title = $ref('选择用户')
// 用户类型
let userType = $ref('')
...
const submitForm = () => {
  ...
  console.log(selectedUsers, formKey,'selectedUsers, formKey')
  emit('submit', selectedUsers, formKey)
  cancel()
}
