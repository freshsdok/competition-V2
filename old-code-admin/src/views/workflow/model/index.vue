  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" label-width="68px">
      <el-form-item label="模型标识" prop="modelKey">
        <el-input v-model.trim="queryParams.modelKey" placeholder="请输入模型标识" clearable @change="handleQuery"
          :maxlength="500" />
      </el-form-item>
      <el-form-item label="模型名称" prop="modelName">
        <el-input v-model.trim="queryParams.modelName" placeholder="请输入模型名称" clearable @change="handleQuery"
          :maxlength="500" />
      </el-form-item>
      <el-form-item label="流程分类" prop="category">
        <el-select v-model="queryParams.category" clearable placeholder="请选择流程分类" @change="handleQuery"
          style="width: 200px;">
          ...
          <el-dropdown class="el-dropdown-more" v-hasPermi="[
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <span v-hasPermi="['workflow:model:history']">
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body @close="cancel()">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="描述" prop="description">
          <el-input v-model="form.description" :rows="3" type="textarea" placeholder="请输入描述" maxlength="250"
            show-word-limit />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <el-dialog title="模型历史" v-model="history.open" width="70%">
      ...
      <pagination v-show="historyTotal > 0" :total="historyTotal" v-model:page="queryHistoryParams.pageNum"
        v-model:limit="queryHistoryParams.pageSize" @pagination="getHistoryList" />
    </el-dialog>
