<template>
    <div class="detail-box">
        <el-drawer
            ...
            <!-- 表单设计 -->
            <variantMForm :form="props.form" @save="handleSave" @cancel="handleBack"></variantMForm>
...
import variantMForm from '@/views/tool/variantMForm';
