package com.teaching.common.security.utils;
...
public class SecurityUtils
{
    ...
    public static LoginUser getLoginUser() {
        ...
        if(Objects.nonNull(sysUser) && StringUtils.isNotEmpty(sysUser.getSysUserId())){
            sysUser.setUserId(Long.valueOf(sysUser.getSysUserId()));
            loginUser.setUserid(Long.valueOf(sysUser.getSysUserId()));
        }
        return loginUser;
    }
