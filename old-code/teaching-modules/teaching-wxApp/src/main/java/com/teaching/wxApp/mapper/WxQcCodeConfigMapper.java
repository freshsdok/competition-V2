 ...
 * @date 2026-04-08
 */
public interface WxQcCodeConfigMapper {
    ...
    public List<WxQcCodeConfig> selectWxQcCodeConfigList1(WxQcCodeConfig wxQcCodeConfig);
     ...
     * 批量删除二维码配置
     *
     * @param codeConfigIds 需要删除的数据主键集合
     * @return 结果
     */
