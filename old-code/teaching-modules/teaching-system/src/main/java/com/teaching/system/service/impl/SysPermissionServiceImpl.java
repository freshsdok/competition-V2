...
import com.teaching.system.service.ISysPermissionService;
    ...
    public void getRoleMenuList(SysUser user) {
        ...
        if(!CollectionUtils.isEmpty(roles)){
            roles.stream().forEach(role -> {
                List<SysRoleMenu> sysRoleMenus = roleMenuMapper.selectSysRoleMenuByRoleId(role.getRoleId());
                role.setMenuIds(sysRoleMenus);
            });
        }
    }
}
