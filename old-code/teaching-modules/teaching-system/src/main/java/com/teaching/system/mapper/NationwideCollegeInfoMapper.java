 ...
 * @date 2025-12-03
 */
public interface NationwideCollegeInfoMapper {
    /**
     * 查询全国院校信息
     *
     * @param id 全国院校信息主键
    ...
    public NationwideCollegeInfo selectNationwideCollegeInfoBySchoolName(String name);
     ...
     * @return
     */
    public List<NationwideCollegeInfo> selectNationwideCollegeInfoByNameLimit10(NationwideCollegeInfo nationwideCollegeInfo);
