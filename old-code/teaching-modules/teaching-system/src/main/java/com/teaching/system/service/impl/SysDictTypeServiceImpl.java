...
import com.teaching.system.api.domain.SysDictType;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    /**
     * 根据字典类型和值查询信息
     * @param dictType dictType sys_user_sex
     * @param value value 0
     * @return SysDictData 性别男的记录
     */
    @Override
    public SysDictData selectDictDataByTypeAndValue(String dictType, String value) {
