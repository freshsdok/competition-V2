...
public class SM2Util {
    ...
    private static final Integer SIGN_MAX_TIME = 60;
    ...
    public boolean verify(String plainText, String signatureValue, String pubKey,long timestamp) throws NoSuchAlgorithmException, InvalidKeySpecException,
            InvalidKeyException, SignatureException {
        /*
         * 判断timestamp时间戳与当前时间是否操过60s（过期时间根据业务情况设置）,如果超过了就提示签名过期。
         */
        long now = System.currentTimeMillis() / 1000;
        if (now - timestamp > SIGN_MAX_TIME) {
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException {
        // 需要加密或签名的对象
        String str = "https://blog.csdn.net/weixin_38548646/article/details/151614770";
        ...
        try {
            ...
            boolean verify = sm2.verify(str, signStr, pubKey, System.currentTimeMillis() / 1000);
