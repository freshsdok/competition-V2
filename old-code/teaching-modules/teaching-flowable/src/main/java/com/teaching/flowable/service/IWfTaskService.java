...
public interface IWfTaskService {
     ...
     * @return
     */
    Map<String, Object> getProcessVariablesByTraceabilityCode(String traceabilityCode);
    /**
     * 启动第一个任务
     *
     ...
     * @param key
     */
    int designatedPerson(String processInstanceId, String key, Set<Long> users);
}
