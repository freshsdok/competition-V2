...
import com.teaching.flowable.service.IWfInstanceService;
            ...
            taskInstanceList.forEach(taskInstance -> {
                ...
                if (StringUtils.isNotBlank(taskInstance.getAssignee())) {
                    ...
                    if(R.isSuccess(userInfoById) &&userInfoById.getData()!=null){
                        taskVo.setAssigneeName(userInfoById.getData().getNickName());
                    }
                        ...
                        if (StringUtils.isNotBlank(identityLink.getGroupId())) {
                            if (identityLink.getGroupId().startsWith(TaskConstants.ROLE_GROUP_PREFIX)) {
                               ...
                               /* SysDept dept = deptService.selectDeptById(deptId);
                                ...
                                Long postId = Long.parseLong(StringUtils.stripStart(identityLink.getGroupId(), TaskConstants.POST_GROUP_PREFIX));
