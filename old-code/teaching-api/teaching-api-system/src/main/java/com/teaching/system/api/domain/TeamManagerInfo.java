...
/**
 * 团队管理对象 team_manager_info
 *
 * @author teaching
 * @date 2025-10-13
 */
public class  TeamManagerInfo extends BaseEntity
{
...
//    @Excel(name = "支付时间", dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    public TeamManagerInfo(Long teamId, String checkStatus) {
        this.teamId = teamId;
...
//            @Excel(name = "教师邮箱2", targetAttr = "email", type = Excel.Type.EXPORT),
    ...
    /** 团队成员列表 */
    private List<CompetitionApplyInfo> teamMemberRelaList;

    private List<CompetitionApplyInfo> guidTeacherList;
    ...
    public List<CompetitionApplyInfo> getTeamMemberRelaList() {
        return teamMemberRelaList;
    }

    public void setTeamMemberRelaList(List<CompetitionApplyInfo> teamMemberRelaList) {
        this.teamMemberRelaList = teamMemberRelaList;
    }

    public List<CompetitionApplyInfo> getGuidTeacherList() {
        return guidTeacherList;
    }

    public void setGuidTeacherList(List<CompetitionApplyInfo> guidTeacherList) {
