...
// 待接受的流程
export function listwaitingList(query) {
  return request({
    url: '/workflow/process/waitingList',
    method: 'get',
    params: query
  })
}
...
// 催办
export function hastenProcess(query) {
  return request({
    url: '/workflow/process/hasten',
    method: 'get',
    params: query
  })
}
...
// 流程发起人筛选条件
export function getStartUserList(query) {
  return request({
    url: '/system/user/getStartUserList',
    method: 'get',
    params: query
  })
}
...
export function getlistUser(query) {
    return request({
        url: '/system/user/getUserList/sjwgcy',
        method: 'get',
        params: query
    })
}