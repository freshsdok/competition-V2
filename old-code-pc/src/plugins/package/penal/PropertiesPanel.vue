  ...
  <div class="process-panel__container" :style="{ width: `${this.width}px` }">
    <el-collapse v-model="activeTab">
      <el-collapse-item name="base">
        <template #title>
          <div class="panel-tab__title"><el-icon><InfoFilled /></el-icon>常规</div>
        </template>
      ...
      <el-collapse-item name="multiInstance" v-if="elementType.indexOf('Task') !== -1 && elementType !== 'UserTask'" key="multiInstance">
        <template #title>
          <div class="panel-tab__title"><el-icon><Menu /></el-icon>多实例</div>
        </template>
        <element-multi-instance :business-object="elementBusinessObject" :type="elementType" />
      </el-collapse-item>
      <el-collapse-item name="listeners" key="listeners">
        <template #title>
          <div class="panel-tab__title"><el-icon><BellFilled /></el-icon>执行监听器</div>
        </template>
        <element-listeners :id="elementId" :type="elementType" />
      </el-collapse-item>
      <el-collapse-item name="taskListeners" v-if="elementType === 'UserTask'" key="taskListeners">
        <template #title>
          <div class="panel-tab__title"><el-icon><BellFilled /></el-icon>任务监听器</div>
        </template>
        <user-task-listeners :id="elementId" :type="elementType" />
      </el-collapse-item>
      <el-collapse-item name="extensions" key="extensions">
        <template #title>
          <div class="panel-tab__title"><el-icon><CirclePlusFilled /></el-icon>扩展属性</div>
        </template>
...
export default {
  ...
  created() {
    this.bpmnModeler = this.modelerData.data;
    this.initModels();
  },
  methods: {
    initModels() {
