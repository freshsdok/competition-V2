    ...
    <div class="loginright">
      ...
      <div v-if="activeName === 'first'" class="loginform">
        <el-form :model="form" label-width="auto" :rules="rules" ref="formRef">
          ...
          <div class="zhuc">
            <span class="lansebut" @click="register">去登录</span>
          </div>
...
<script setup>
import { authresetPwd, getPhoneCode, sendEmailCode } from "@/api/index";
  ...
  formRef.value?.validate((valid) => {
    if (valid) {
      const params = {
        ...
        email: form.email,
         userName:form.phonenumber?form.phonenumber:form.email,
